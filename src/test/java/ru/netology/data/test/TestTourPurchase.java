...
public class TestTourPurchase {
    ...
    void shouldOfSuccessfulPurchaseTourWithValidCard1() {
    ...
    void shouldOfSuccessfulPurchaseTourWithValidCard2() {
        element.chooseBy("Оплата по карте");
    ...
    void thereMustBeAnUnsuccessfulPurchaseTourWithAnInvalidCard3() {
        element.chooseBy("Оплата по карте");
